    ...
    >
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-xl md:text-2xl text-zinc-600 dark:text-zinc-400 mb-12 max-w-2xl mx-auto leading-relaxed">
          ...
          Diplômé d'OpenClassrooms en développement JavaScript (RNCP niveau 6).
        </p>

        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <a
            href="#projects"
            className="px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-full font-semibold transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105"
          >
            Voir mes projets
          </a>
          <a
            href="#contact"
            className="px-8 py-4 border-2 border-zinc-300 dark:border-zinc-700 hover:border-blue-600 dark:hover:border-blue-400 text-zinc-900 dark:text-zinc-100 rounded-full font-semibold transition-all duration-300 hover:scale-105"
          >
            Me contacter
          </a>
        </div>
